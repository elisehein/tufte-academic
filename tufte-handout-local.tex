...
\newfontfamily\futurafont[Path=/Library/Fonts/,
                          Extension=.ttc,
                          Ligatures=TeX]{Futura}
\newcommand{\mysffamily}{\futurafont}

% Nicer maketitle. Just copied from tufte-common and tweaked some parameters.
% Just remove section to get back default italic title.
% ---------------------------
...
\fancyhead[RE,RO]{\scriptsize\mysffamily\allcaps{\newlinetospace{\plaintitle}}}
\lfoot{\footnotesize\mysffamily\allcaps{abcdef}\quad$\cdot$\quad\allcaps{e}\hspace{-0.3pt}f\allcaps{d}}
\rfoot{\footnotesize\mysffamily\thepage}
